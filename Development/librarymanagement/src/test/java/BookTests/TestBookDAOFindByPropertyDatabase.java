 ...
 * @author Agent47
 */
public class TestBookDAOFindByPropertyDatabase {
    ...
    public static void main(String[] args) throws IllegalAccessException {
        ...
        String propertyname="publishdate";
        Object propertyValue = "2005-05-05";
        
        
        
        List<Book> user = bookdao.findByProperty(propertyname, propertyValue);
